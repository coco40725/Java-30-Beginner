...
/*
* 1.  開發中，我們需要對 對象進行排序，換言之，我們要表較對象的大小。使用interface: Comparable 或 Comparator。
* 2. Comparable 使用: 自然排序
...
*
* 3. Comparator : 自製排序
*    - 使用時機: a. 當有些類沒有實現 comparable 但又不方便去改code，則可以使用Comparator
...
*               返回0，代表相等；
                返回負整數，代表 o1 < o2
    --------------------------------------------------------------------------------------------
    * Comparable and Comparator 差異:
    * 1. Comparable 是一旦在類中定義好，後續只要是這個類都可以直接調用
    * 2. Comparator 屬於臨時性的，只適用於當下，後續想再用這個排序方法，需要再寫一次。
**/

/**
 * @author Yu-Jing
 * @create 2022-07-04-PM 03:35
 */
